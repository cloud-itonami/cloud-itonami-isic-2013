# Operator Quickstart — Manufacture of plastics and synthetic rubber in primary forms

Shortest path from clone to a verified local dry-run for **ISIC 2013** (`cloud-itonami-isic-2013`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2013.git
cd cloud-itonami-isic-2013
```
...
- Blueprint governor key: `primary-forms-plant-operations-governor`
- Likely source path: `resinmfg.governor.cljc`
