# Business Model: Manufacture of plastics and synthetic rubber in primary forms
...
## Classification
- Repository: `cloud-itonami-isic-2013` ([github.com/cloud-itonami/cloud-itonami-isic-2013](https://github.com/cloud-itonami/cloud-itonami-isic-2013))
- ISIC Rev.5: `2013` — Manufacture of plastics and synthetic rubber in primary forms
- Domain: `:primary-plastics-rubber/manufacturing`
- Social impact: :worker-safety :materials-safety :resource-efficiency
- Actor: `:primary-forms-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :primary-plastics-rubber/manufacturing — who wants
...
One managed tenant (:primary-plastics-rubber/manufacturing):
...
- Do not bypass the `:primary-forms-plant-operations-governor` for production decisions.
