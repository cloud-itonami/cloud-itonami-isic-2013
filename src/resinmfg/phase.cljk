(ns resinmfg.phase
  "Phase 0->3 staged rollout for the plastics-and-synthetic-rubber
  PRIMARY FORMS plant-operations coordination actor.
  ...
  consequence (a polymerization/compounding-reactor maintenance window
  means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `resinmfg.governor`'s `reactor-actuate-blocked-violations` HARD-blocks
...
(defn verdict->disposition
  "Map a Primary Forms Plant Operations Governor verdict to a base
