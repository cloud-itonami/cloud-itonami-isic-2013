(ns resinmfg.registry-test
  (:require [clojure.test :refer [deftest is]]
            [resinmfg.registry :as r]))
...
(deftest known-polymer-grades-are-valid
  (doseq [g [:pp :pe-hdpe :pe-ldpe :pvc :ps :abs :pet :pc :nylon
             :sbr :br :nbr :epdm :cr :iir]]
    (is (r/polymer-grade-valid? g))))

(deftest fabricated-polymer-grade-is-invalid
  (is (not (r/polymer-grade-valid? :unobtainium)))
  (is (not (r/polymer-grade-valid? nil))))
